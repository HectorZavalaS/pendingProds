...
namespace pendingProds.Models
{
    ...
    public partial class siixsem_sys_lblPrint_dbEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> getDjGroupBySerial(string serial)
        {
            var serialParameter = serial != null ?
                new ObjectParameter("serial", serial) :
                new ObjectParameter("serial", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("getDjGroupBySerial", serialParameter);
        }
    }
}
